...
class QuestionDetailFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        if(answer3 != null && answer4 != null) {
            ...
            setCorrectAnswerFirstIfMultiple()
        }

        else {
            answersList.add(answer1!!)
            answersList.add(answer2!!)
            answer3TextView.visibility = View.GONE
            answer4TextView.visibility = View.GONE
            setCorrectAnswerFirstIfBoolean()
        }

        return rootView
    }

    fun setCorrectAnswerFirstIfMultiple(){
    ...
    fun setCorrectAnswerFirstIfBoolean(){
        val list = answersList.filterNot { it == correctAnswer}
        answer1TextView.text = correctAnswer
        answer2TextView.text = list[0]
    }
